...
NSString * const TI_APPLICATION_ID = @"company.name";
NSString * const TI_APPLICATION_PUBLISHER = @"bryanbotsford1";
NSString * const TI_APPLICATION_URL = @"http://com.companyname";
NSString * const TI_APPLICATION_NAME = @"Botsford_Bryan_Project4";
