...
@interface Botsford_Bryan_Project4Object : KrollCoverageObject {
#else
@interface Botsford_Bryan_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Botsford_Bryan_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Botsford_Bryan_Project4Object *_botsford_bryan_project4;
    KrollObject* console;
	BOOL shutdown;
