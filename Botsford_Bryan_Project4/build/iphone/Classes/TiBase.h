...
// in simulator we redefine to format for Botsford_Bryan_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.botsford_bryan_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.botsford_bryan_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBotsford_Bryan_Project4NativeItemNone = -1, 
	UIBotsford_Bryan_Project4NativeItemSpinner = -2,
	UIBotsford_Bryan_Project4NativeItemProgressBar = -3,
	
	UIBotsford_Bryan_Project4NativeItemSlider = -4,
	UIBotsford_Bryan_Project4NativeItemSwitch = -5,
	UIBotsford_Bryan_Project4NativeItemMultiButton = -6,
	UIBotsford_Bryan_Project4NativeItemSegmented = -7,
	
	UIBotsford_Bryan_Project4NativeItemTextView = -8,
	UIBotsford_Bryan_Project4NativeItemTextField = -9,
	UIBotsford_Bryan_Project4NativeItemSearchBar = -10,
	
	UIBotsford_Bryan_Project4NativeItemPicker = -11,
	UIBotsford_Bryan_Project4NativeItemDatePicker = -12,
	
	UIBotsford_Bryan_Project4NativeItemInfoLight = -13,
	UIBotsford_Bryan_Project4NativeItemInfoDark = -14,
	
	UIBotsford_Bryan_Project4NativeItemDisclosure = -15,
	
	UIBotsford_Bryan_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Botsford_Bryan_Project4 instances of
