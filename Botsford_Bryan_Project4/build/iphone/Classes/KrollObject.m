...
//@interface Botsford_Bryan_Project4Object : NSObject
//@end

@interface Botsford_Bryan_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Botsford_Bryan_Project4Object class]])
		{
			for (NSString *key in [[(Botsford_Bryan_Project4Object*)o modules] allKeys])
			{
