...
// in simulator we redefine to format for BuckleMobile Developer console
...
{\
	NSString * exceptionName = [@"org.bucklemobile." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bucklemobile";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBuckleMobileNativeItemNone = -1, 
	UIBuckleMobileNativeItemSpinner = -2,
	UIBuckleMobileNativeItemProgressBar = -3,
	
	UIBuckleMobileNativeItemSlider = -4,
	UIBuckleMobileNativeItemSwitch = -5,
	UIBuckleMobileNativeItemMultiButton = -6,
	UIBuckleMobileNativeItemSegmented = -7,
	
	UIBuckleMobileNativeItemTextView = -8,
	UIBuckleMobileNativeItemTextField = -9,
	UIBuckleMobileNativeItemSearchBar = -10,
	
	UIBuckleMobileNativeItemPicker = -11,
	UIBuckleMobileNativeItemDatePicker = -12,
	
	UIBuckleMobileNativeItemInfoLight = -13,
	UIBuckleMobileNativeItemInfoDark = -14,
	
	UIBuckleMobileNativeItemDisclosure = -15,
	
	UIBuckleMobileNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BuckleMobile instances of
