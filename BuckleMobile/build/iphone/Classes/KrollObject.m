...
//@interface BuckleMobileObject : NSObject
//@end

@interface BuckleMobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BuckleMobileObject class]])
		{
			for (NSString *key in [[(BuckleMobileObject*)o modules] allKeys])
			{
