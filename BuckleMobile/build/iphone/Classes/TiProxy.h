...
//Rare exceptions to indicate a bug in the _bucklemobile code (Eg, function that a subclass should have implemented)
...
/**
 The base class for BuckleMobile proxies.
 */
