...
@interface BuckleMobileObject : KrollCoverageObject {
#else
@interface BuckleMobileObject : KrollObject {
#endif
@private
...
extern NSString * BuckleMobile$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	BuckleMobileObject *_bucklemobile;
    KrollObject* console;
	BOOL shutdown;
