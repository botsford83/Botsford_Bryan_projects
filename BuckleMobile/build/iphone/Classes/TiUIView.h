...
/**
 Base class for all BuckleMobile views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the BuckleMobile view hierarchy (such as wrapped iOS UIViews) was touched.
