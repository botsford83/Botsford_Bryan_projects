...
@interface Botsford_Bryan_Project3Object : KrollCoverageObject {
#else
@interface Botsford_Bryan_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Botsford_Bryan_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Botsford_Bryan_Project3Object *_botsford_bryan_project3;
    KrollObject* console;
	BOOL shutdown;
