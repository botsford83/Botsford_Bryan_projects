...
// in simulator we redefine to format for Botsford_Bryan_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.botsford_bryan_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.botsford_bryan_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBotsford_Bryan_Project3NativeItemNone = -1, 
	UIBotsford_Bryan_Project3NativeItemSpinner = -2,
	UIBotsford_Bryan_Project3NativeItemProgressBar = -3,
	
	UIBotsford_Bryan_Project3NativeItemSlider = -4,
	UIBotsford_Bryan_Project3NativeItemSwitch = -5,
	UIBotsford_Bryan_Project3NativeItemMultiButton = -6,
	UIBotsford_Bryan_Project3NativeItemSegmented = -7,
	
	UIBotsford_Bryan_Project3NativeItemTextView = -8,
	UIBotsford_Bryan_Project3NativeItemTextField = -9,
	UIBotsford_Bryan_Project3NativeItemSearchBar = -10,
	
	UIBotsford_Bryan_Project3NativeItemPicker = -11,
	UIBotsford_Bryan_Project3NativeItemDatePicker = -12,
	
	UIBotsford_Bryan_Project3NativeItemInfoLight = -13,
	UIBotsford_Bryan_Project3NativeItemInfoDark = -14,
	
	UIBotsford_Bryan_Project3NativeItemDisclosure = -15,
	
	UIBotsford_Bryan_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Botsford_Bryan_Project3 instances of
