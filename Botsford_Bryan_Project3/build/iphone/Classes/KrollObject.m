...
//@interface Botsford_Bryan_Project3Object : NSObject
//@end

@interface Botsford_Bryan_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Botsford_Bryan_Project3Object class]])
		{
			for (NSString *key in [[(Botsford_Bryan_Project3Object*)o modules] allKeys])
			{
